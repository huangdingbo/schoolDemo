...
class GeneralName
{
    ...
    private function getXing(){
        $xingNum = count($this->xingArr);

        $key = rand(0,$xingNum-1);

        return $this->xingArr[$key];
    }

    private function getMing(){
        $num = rand(1,2);

        $mingNum = count($this->mingArr);
        ...
        {
            case 1;
            $ming = $this->mingArr[rand(0,$mingNum-1)];
            break;

            case 2;
            $ming = $this->mingArr[rand(0,$mingNum-1)] . $this->mingArr[rand(0,$mingNum-1)];
            break;
        }
