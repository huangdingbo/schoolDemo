    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'label' => '任务类型',
                'value' => function($dataProvider){
                        return TaskToolModel::$types[$dataProvider->type];
                },
                'filter' => TaskToolModel::$types,
            ],
            [
                'attribute' => 'info',
                'value' => 'info',
            ...
            [
                ...
                'label' => '任务状态',
                'value' => function($dataProvider){
                    return TaskToolModel::$status[$dataProvider->status] ;
                },
                'contentOptions' => function($dataProvider){
                    return  ['class' => TaskToolModel::$colors[$dataProvider->status]] ;
                },
                'filter' => TaskToolModel::$status,
            ],
            'last_start_time',
            'last_finish_time',
            'run_time',
